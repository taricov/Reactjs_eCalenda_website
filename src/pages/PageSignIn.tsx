  ...
  return (
    <div className="w-full my-20">
      <div className="w-full max-w-md mx-auto p-8 space-y-3 rounded-xl">
        <h1 className="text-4xl font-bold text-center text-app-color-700 dark:text-app-color-200 my-10">
          Sign In
        </h1>
        ...
        <div className="flex items-center pt-4 space-x-1">
          <div className="flex-1 h-px sm:w-16 dark:bg-app-color-300 bg-app-color-500"></div>
          <p className="px-3 text-sm text-app-color-500 dark:text-app-color-300">
        ...
        <div className="flex justify-center space-x-4">
          <button
            ...
            className="p-3 rounded-sm dark:text-app-color-300 text-app-color-500 hover:text-app-color-400 dark:hover:text-app-color-100 transition-all duration-200"
          >
            <svg
          ...
          <button
            ...
            className="dark:hover:text-app-color-100 p-3 rounded-sm dark:text-app-color-300 text-app-color-500 hover:text-app-color-400 transition-all duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
        ...
        <p className="text-xs text-center sm:px-6 dark:text-app-color-300 text-app-color-500">
