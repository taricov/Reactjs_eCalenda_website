export default function PageTestimonails() {
  return (
    <>
      <section className="text-app-color-200 body-font my-40">
        <div className="container px-5 py-24 mx-auto">
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="inline-block w-8 h-8 text-app-color-100 mb-8"
            ...
            <span className="inline-block h-1 w-10 rounded bg-app-color-500 mt-8 mb-6"></span>
            <h2 className="text-app-color-100 font-medium title-font tracking-wider text-sm">
              HOLDEN CAULFIELD
            </h2>
            <p className="text-app-color-600">Senior Product Designer</p>
          </div>
        </div>
      </section>
    </>
