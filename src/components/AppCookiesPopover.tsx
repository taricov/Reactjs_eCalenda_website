      ...
      >
        <div className="flex items-center gap-x-4">
          <span className="inline-flex p-2 text-blue-500 rounded-lg shrink-0 dark:bg-app-color-300 bg-app-color-500  ">
            ...
            >
              <path
                ...
                // fill="white"
                className="fill-app-color-200 dark:fill-app-color-700"
              />
            </svg>
          </span>
          ...
          <p className="text-sm text-app-color-700 dark:text-app-color-200">
            ...
            <a
              href="/privacy"
              className="text-app-color-700 text-opacity-50 transition duration-200 hover:text-opacity-90 hover:underline dark:text-app-color-100  dark:hover:text-opacity-80 dark:text-opacity-50"
            >
        ...
        <div className="flex items-center mt-6 gap-x-4 shrink-0 lg:mt-0">
          <button
            className="w-1/2 text-xs text-app-color-700 underline transition-colors duration-300 md:w-auto dark:text-app-color-100 dark:hover:text-app-color-300 hover:text-app-color-300 focus:outline-none"
          ...
          <button
            className=" text-xs w-1/2 md:w-auto font-medium dark:text-app-color-800  dark:bg-app-color-300 dark:hover:bg-app-color-200 bg-app-color-500 rounded-lg hover:bg-app-color-600 text-white px-4 py-2.5 duration-300 transition-colors focus:outline-none"
            onClick={acceptCookies}
          >
            Accept All Cookies
          </button>
